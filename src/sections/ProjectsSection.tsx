...
const PROJECTS: Project[] = [
  {
    ...
    images: [
      `${import.meta.env.BASE_URL}images/board-1.jpg`,
      `${import.meta.env.BASE_URL}images/board-2.jpg`,
      `${import.meta.env.BASE_URL}images/board-3.jpg`,
      `${import.meta.env.BASE_URL}images/board-4.jpg`,
    ],
  ...
  },
  {
    ...
    images: [],
    analysis: {
      image: `${import.meta.env.BASE_URL}images/zhuangban-report.jpg`,
      title: '分析角度',
      intro:
      ...
      sideImages: [
        `${import.meta.env.BASE_URL}images/zh-data-1.jpg`,
        `${import.meta.env.BASE_URL}images/zh-data-2.jpg`,
        `${import.meta.env.BASE_URL}images/zh-data-3.jpg`,
        `${import.meta.env.BASE_URL}images/zh-data-4.jpg`,
      ],
      compNote:
        '系统梳理五大竞品 App（爱奇艺、芒果、Bilibili、QQ音乐、QQ）在装扮商城、我的装扮、装扮点位、装扮推广四个核心维度的现状，建立行业基线认知',
      compImages: [
        `${import.meta.env.BASE_URL}images/comp-1.jpg`,
        `${import.meta.env.BASE_URL}images/comp-2.jpg`,
        `${import.meta.env.BASE_URL}images/comp-3.jpg`,
        `${import.meta.env.BASE_URL}images/comp-4.jpg`,
        `${import.meta.env.BASE_URL}images/comp-5.jpg`,
      ],
      priorityNote:
        '对标竞品能力，聚焦装扮后台打通、商城体验升级、APP 内权益绑定、装扮资产管理、点位丰富、装扮入口优化、推广玩法七大方向，提出16条可扩展能力',
      priorityImages: [`${import.meta.env.BASE_URL}images/prior-1.jpg`, `${import.meta.env.BASE_URL}images/prior-2.jpg`],
    },
  },
]
            ...
            <div className="flex items-center gap-4 sm:gap-6 md:gap-8">
              ...
              <div className="relative flex flex-col gap-1 sm:gap-2">
                ...
                {project.number === '01' && (
                  ...
                  >
                    <Model3DViewer
                      modelPath={`${import.meta.env.BASE_URL}models/kite.glb`}
                      baseY={0}
                      frameMargin={0.95}
                      lightBoost={1.8}
                      dpr={[1, 2]}
