...
const SKILL_GROUPS: { label: string; tools: Tool[] }[] = [
  {
    label: 'VIBE CODING',
    tools: [
      { name: 'Codex', iconUrl: `${import.meta.env.BASE_URL}icons/chatgpt.svg` },
      { name: 'Claude Code', iconUrl: `${import.meta.env.BASE_URL}icons/claude.svg` },
      { name: 'Workbuddy', iconUrl: `${import.meta.env.BASE_URL}icons/codebuddy.svg` },
    ],
  },
  {
    label: '设计',
    tools: [
      { name: 'Figma', iconUrl: `${import.meta.env.BASE_URL}icons/figma.svg` },
      { name: 'Axure', iconUrl: `${import.meta.env.BASE_URL}icons/axure.ico` },
      { name: '墨刀', iconUrl: `${import.meta.env.BASE_URL}icons/modao.ico` },
    ],
  },
  {
    label: '数据',
    tools: [
      { name: 'MySQL', iconUrl: `${import.meta.env.BASE_URL}icons/mysql.svg` },
      { name: 'Python', iconUrl: `${import.meta.env.BASE_URL}icons/python.svg` },
      { name: 'Tableau', iconUrl: `${import.meta.env.BASE_URL}icons/tableau.ico` },
    ],
  },
]
      ...
      <FadeIn delay={0} y={40}>
        ...
        <div className="relative flex items-center justify-center gap-2 sm:gap-3 md:gap-4 mb-6 sm:mb-7 md:mb-8">
          ...
          <div className="w-[200px] sm:w-[260px] md:w-[320px] h-[200px] sm:h-[260px] md:h-[320px]">
            <Model3DViewer
              modelPath={`${import.meta.env.BASE_URL}models/qingzhu.glb`}
              baseY={0}
              frameMargin={1.05}
              scale={1.54}
              dpr={[1, 2]}
