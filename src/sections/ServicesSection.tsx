...
const EXPERIENCES: Experience[] = [
  {
    company: '腾讯',
    logo: `${import.meta.env.BASE_URL}logos/tencent.png`,
    logoBg: '#1F8AFF',
    logoFg: '#ffffff',
    role: '腾讯视频产品策划',
  ...
  {
    company: '识货',
    logo: `${import.meta.env.BASE_URL}logos/shihuo.jpg`,
    logoBg: '#E60023',
    logoFg: '#ffffff',
    role: '产品经理',
  ...
  {
    company: '美团',
    logo: `${import.meta.env.BASE_URL}logos/meituan.png`,
    logoBg: '#FFD000',
    logoFg: '#1A1A1A',
    role: '评价消费产品经理',
  ...
  {
    company: '携程',
    logo: `${import.meta.env.BASE_URL}logos/ctrip.png`,
    logoBg: '#2C8EFC',
    logoFg: '#ffffff',
    role: '入境游产品经理',
        ...
        <div className="relative z-20" style={{ height: 'min(38vw, 620px)', marginTop: 'calc(2vh - clamp(2.8125rem, 3.15vw, 3.09375rem) - 10vh)' }}>
          ...
          >
            <div style={{ width: '100%', height: '100%', transform: 'translateY(-6.6667vh)' }}>
              <Model3DViewer modelPath={`${import.meta.env.BASE_URL}models/pa.glb`} baseY={0.22} frameMargin={1.36} dpr={[1, 2]} />
            </div>
          </div>
        </div>
